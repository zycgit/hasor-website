...
import net.hasor.website.domain.enums.BodyFormat;
import net.hasor.website.domain.enums.ContentStatus;
import net.hasor.website.domain.enums.ContentType;
import net.hasor.website.domain.futures.ContentFutures;
