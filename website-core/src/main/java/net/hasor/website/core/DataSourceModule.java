...
import net.hasor.plugins.mybatis3.MyBatisModule;
...
public class DataSourceModule implements LifeModule {
    ...
    public void loadModule(ApiBinder apiBinder) throws Throwable {
        ...
        apiBinder.installModule(new JdbcModule(Level.Full, AppConstant.DB_HSQL, dataSource));
        //
        // .外置数据(数据源二)
        ...
        apiBinder.installModule(new JdbcModule(Level.Full, AppConstant.DB_MYSQL, mysqlDataSource));
